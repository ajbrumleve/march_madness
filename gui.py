...
class MainPanel(wx.Panel):
    ...
    def predict(self,event):
        ...
        try:
            team1_vector = self.data_instance.getSeasonData(self.data_instance.teams_pd[self.data_instance.teams_pd['Team_Name'] == team_1_name].values[0][0], 2022)
            team2_vector = self.data_instance.getSeasonData(self.data_instance.teams_pd[self.data_instance.teams_pd['Team_Name'] == team_2_name].values[0][0], 2022)
        except:
